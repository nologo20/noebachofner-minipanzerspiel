...
public class ChooseTankColorDialog extends JDialog{
    ...
    private final JButton setTurretColorButton = new JButton("Turm Farbe ändern");
    private final JButton setCannonColorButton = new JButton("Kanonen Farbe ändern...");
    private final JButton cancelButton = new JButton("Abbrechen");
    private final JButton applyButton = new JButton("aktualisieren");
    ...
    private void registerButtonListeners() {
        ...
        setTurretColorButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Color newTurretColor = JColorChooser.showDialog(null, "Turm Farbe wählen", tempTurretColor);
        ...
        setCannonColorButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Color newCannonColor = JColorChooser.showDialog(null, "Kanone Farbe wählen", tempCannonColor);
